...
def simulate_abba_baba(introgression):
    ABBA = 1000 * (0.1 + 0.8 * introgression)
    BABA = 1000 * (0.1 + 0.1 * introgression)
    return ABBA, BABA
...
# 保存动画
# ani.save(r'abba_baba.mp4', writer='ffmpeg', fps=30, dpi=150)
